...
class Esthetique extends beauteEtSoins_model_1.BeauteEtSoins {
    constructor() {
        super(...arguments);
        this.criteres = {
            tarif_horaire: 80,
        ...
        this.label = 'esthetique';
        this.userid = '';
        this.location = { address: '', lat: 0, lng: 0 };
    }
}
exports.Esthetique = Esthetique;
//# sourceMappingURL=esthetique.model.js.map