    ...
    constructor() {
        this.criteres = {
            ...
            vinHonneurCocktailBuffet: {
                type: field_type_enum_1.FieldTypeEnum.TOGGLE_VIN_HONNEUR_COCKTAIL_BUFFET,
                value: false,
                quantity: 5,
                products: [
                    {
            ...
            Dinner: {
                type: field_type_enum_1.FieldTypeEnum.TOGGLE_DINNER,
                value: false,
                dinerCapacite: 300,
                convivesMin: 15,
                products: [
...
exports.Traiteur = Traiteur;
//# sourceMappingURL=traiteur.model.js.map