...
let NotificationsRepository = class NotificationsRepository extends typeorm_1.Repository {
    constructor() {
        super();
    }
};
NotificationsRepository = __decorate([
    typeorm_1.EntityRepository(notifications_entity_1.NotificationsEntity),
