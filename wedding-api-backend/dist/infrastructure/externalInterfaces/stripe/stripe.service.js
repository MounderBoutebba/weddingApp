...
exports.stripe = new Stripe(configService.get(`STRIPE_API_KEY`));
let StripeService = class StripeService {
    ...
    async createAccount(accountInfo, user, bankAccount) {
    ...
    async getAccount(accountId, bankAccountId) {
    ...
    async updateCustomer(id, customerInfo) {
        const customer = await this.stripe.customers.createSource(id, customerInfo);
        return customer;
    }
    async createPaymentIntent(customerId, montant, invoiceId) {
    ...
    async updateCustomerSource(id, customerInfo) {
    ...
    async createCardToken(cardBank) {
        const card = {
            object: 'card',
    ...
    async makeRefund(charge) {
        const refund = await exports.stripe.charges.refund(charge.id, {
            amount: charge.amount
        });
        return refund;
    }
    async createTransfer(transfertToCustomer) {
