...
export interface PhotographeCriteresES{
    ...
    photographe_creationAlbum: {
        ...
        formats: {
            ...
            name: string,
            value: boolean,
            modeles: { name: string, tarif: number, checked: boolean}[],
        }[],
    };
    ...
    photographe_retouchesPhotoFormats: { name: string; tarifUnitaire: number }[];

    photographe_remise: boolean;
    photographe_remiseFormats: { name: string; tarifUnitaire: number }[];
...
export interface VideasteCriteresES {
    ...
    videaliste_remiseFormats: { name: string; tarifUnitaire: number }[];
...
export interface LieuBooking {
	selected: boolean,
	debutLocation?: { min: number, heure: number };
	limiteHoraire?: { min: number, heure: number };
