...
@Component({
  ...
  styleUrls: ['./avis-client.component.scss']
})
export class AvisClientComponent implements OnInit, OnDestroy {
  ...
  public refresh(){
    if(this.currentPage===1){
      ...
      this.router.navigateByUrl(`/user/reservation/avis-client`);
    }
  }

  public searchPaginated($event) {
    this.router.navigateByUrl(`/user/reservation/avis-client?page=${$event.pageIndex}`);
  }
