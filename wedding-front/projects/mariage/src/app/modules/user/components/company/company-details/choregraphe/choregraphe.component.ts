...
@Component({
  ...
  styleUrls: ['./choregraphe.component.scss']
})
export class ChoregrapheComponent implements OnInit, AfterViewInit {
	@Input() criteres: any;
  ...
  checkBoxIsRequired: boolean;
	constructor(private readonly choregrapheService: ChoregrapheService,
