...
import { DjCriteres, newDjCriteres } from './dj.interface';
...
export class DjService {
    ...
    public initFormValuesWithCriteria(djCriteria: DjCriteres): DynamicFormFieldInterface[] {
        ...
        'indicate your specialties', true, djCriteria.specialite, [
        ...
        'indicate the instruments which you dispose', true, djCriteria.instruments, [
        ...
        [
            {
                value: djCriteria.nombreIntervenants,
        ...
        `indicate your audience type`, djCriteria.typePublic, false, [
        ...
        `indicate the type of place where you can install and perform`, djCriteria.adaptabiliteLieu, false, [
