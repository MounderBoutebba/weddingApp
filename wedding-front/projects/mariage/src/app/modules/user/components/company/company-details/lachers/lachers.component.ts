...
import { newFeuArtificesCriteres } from '../feu-artifices/feu-artifices.interface';
import { LachersService } from './lachers.service';
import { AuthService } from '../../../../../../core/auth.service';
import { FieldTypeEnum } from '../../../../../shared/components/dynamic-form-builder/models/field-type.enum';
import { DialogService } from '../../../../services/dialog.service';

@Component({
  selector: 'app-lachers',
  templateUrl: './lachers.component.html',
  styleUrls: ['./lachers.component.scss']
})
export class LachersComponent implements OnInit, AfterViewInit {
	@Input() criteres: any;
  ...
  @ViewChild('feuComponent') feuComponent: any;
	...
	currentEmail = '';
	constructor(private readonly lachersService: LachersService,
