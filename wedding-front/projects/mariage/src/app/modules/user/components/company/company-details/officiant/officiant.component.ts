...
import { OfficiantService } from './officiant.service';
...
export class OfficiantComponent implements OnInit, AfterViewInit {
	@Input() criteres: any;
  ...
  checkBoxIsRequired: boolean;
	constructor(private readonly officiantService: OfficiantService,
