...
import { AnimateurEnfantsPricingService } from './animateur-enfants-pricing.service';
...
@Component({
  selector: 'app-animateur-enfants-pricing',
  templateUrl: './animateur-enfants-pricing.component.html',
  styleUrls: ['./animateur-enfants-pricing.component.scss']
})
export class AnimateurEnfantsPricingComponent implements OnInit, AfterViewInit {
  @Input() criteres: any;
  ...
  currentEmail = '';
	...
	constructor(private readonly animateurEnfantsService: AnimateurEnfantsPricingService,
