...
import { newLachersCriteres } from '../../company-details/lachers/lachers.interface';
import { FeuArtificesPricingService } from './feu-artifices-pricing.service';
import { AuthService } from '../../../../../../core/auth.service';
import { FieldTypeEnum } from '../../../../../shared/components/dynamic-form-builder/models/field-type.enum';
import { DialogService } from '../../../../services/dialog.service';
@Component({
  selector: 'app-feu-artifices-pricing',
  templateUrl: './feu-artifices-pricing.component.html',
  styleUrls: ['./feu-artifices-pricing.component.scss']
})
export class FeuArtificesPricingComponent implements OnInit, AfterViewInit {
	@Input() criteres: any;
	...
	currentEmail = '';
	constructor(private readonly feuArtificesService: FeuArtificesPricingService,
