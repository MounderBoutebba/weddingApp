...
import { VoyageNocesPricingService } from './voyage-noces-pricing.service';
import { FieldTypeEnum } from '../../../../../shared/components/dynamic-form-builder/models/field-type.enum';
import { DialogService } from '../../../../services/dialog.service';
@Component({
  selector: 'app-voyage-noces-pricing',
  templateUrl: './voyage-noces-pricing.component.html',
  styleUrls: ['./voyage-noces-pricing.component.scss']
})
export class VoyageNocesPricingComponent implements OnInit, AfterViewInit {
	@Input() criteres: any;
  ...
  currentEmail = '';
	constructor(private readonly voyageNocesService: VoyageNocesPricingService,
